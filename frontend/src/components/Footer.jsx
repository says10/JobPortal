...
export default function Footer() {
  ...
  return (
    <div className="bg-[#e4c49b] text-whblackite text-left">
        ...
        <div className="w-10/12 mx-auto pt-20 pb-8 flex flex-col md:flex-row sm:flex-row space-y-2 justify-start">
          <div className="w-full sm:w-2/5 md:w-3/5 pr-6 flex flex-col space-y-2 pb-6 cursor-default">
            ...
            <span className="font-light">
              Copyright © 2023{" "}
              <span className="font-normal"> Dunder Mifflin Rejects</span>{" "}
              Design.
            </span>
          </div>
          ...
          <div className="w-full sm:w-1/5 md:w-2/5 flex flex-col space-y-2 pb-6">
            <h1 className="text-2xl font-semibold">FindWork</h1>
          ...
          <div className="w-full sm:w-1/5 md:w-2/5 flex flex-col space-y-2 pb-6">
            ...
            <a
              ...
              href="https://www.instagram.com/best_of_utsav___?igsh=MWJzcWpneWZyN3EzNQ%3D%3D&utm_source=qr"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              ...
              href="https://github.com/coDey1410"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="w-10/12 mx-auto pt-20 pb-8 flex flex-col md:flex-row sm:flex-row space-y-2 justify-start">
          <div className="w-full sm:w-2/5 md:w-3/5 pr-6 flex flex-col space-y-2 pb-6 cursor-default">
            ...
            <span className="break-all w-3/4">
              ...
              <strong>Privacy Policy</strong> of FindWork regarding your privacy
              information.
            </span>
