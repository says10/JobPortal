...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-[#e4c49b] w-full">
      <>
          ...
          {linkUrl.pathname.startsWith("/blog") && (
            <div className="flex">
              <Link className="flex pt-1" to="/blog">
                ...
                <h1 className="md:pl-2 pl-2 text-2xl sm:text-2xl md:text-3xl text-[#cd5b45] font-medium hover:opacity-60">
                  FindWork
                </h1>
              ...
              <>
                ...
                {isAuth() ? (
                  ...
                  <>
                    ...
                    <Link
                      className="lg:block hidden text-center transform ease-in duration-100 hover:-translate-y-1 hover:shadow-lg w-32 justify-center px-8 py-2 mb-1 bg-[#cd5b45] text-white rounded-full text-lg font-semibold"
                      to="/sign-up"
                    >
                      Sign up
                    </Link>
